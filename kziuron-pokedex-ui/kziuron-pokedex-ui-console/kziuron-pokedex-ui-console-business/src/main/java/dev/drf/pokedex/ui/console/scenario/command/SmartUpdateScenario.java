...
public class SmartUpdateScenario extends AbstractScenario<ModifyContext, Pokemon> {
    private static final System.Logger LOGGER = System.getLogger(SmartUpdateScenario.class.getName());

    private final ConsoleService consoleService;
    private final PokemonApiService pokemonApiService;
    private final ScenarioStep<Path, Pokemon, ModifyContext> pokemonReadStep;

    public SmartUpdateScenario(ConsoleService consoleService,
    ...
    public ScenarioResult<Pokemon> safeExecute(@Nonnull ModifyContext context) {
        ...
        ApiResult<Pokemon> result = pokemonApiService.smartUpdate(pokemon);
